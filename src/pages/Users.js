    ...
    MySwal.fire({
      ...
      html: (
        <div style={{textAlign: 'left'}}>
          ...
          <input type="text" id="swal-matricule" className="swal2-input" placeholder="Matricule" />
      ...
      preConfirm: () => {
        ...
        if (!fullname || !email || !password || !matricule || !role) {
    ...
    MySwal.fire({
      ...
      html: (
        <div style={{textAlign: 'left'}}>
          ...
          <input type="text" id="swal-fullname-edit" className="swal2-input" placeholder="Nom complet" defaultValue={user.fullname} />
          <label htmlFor="swal-email-edit" style={{display: 'block', marginTop: 8, marginBottom: 4}}>Email :</label>
          <input type="email" id="swal-email-edit" className="swal2-input" placeholder="Email" defaultValue={user.email} />
          <label htmlFor="swal-matricule-edit" style={{display: 'block', marginTop: 8, marginBottom: 4}}>Matricule :</label>
          <input type="text" id="swal-matricule-edit" className="swal2-input" placeholder="Matricule" defaultValue={user.matricule} />
      ...
      cancelButtonText: 'Annuler',
      preConfirm: () => {
        const fullname = document.getElementById('swal-fullname-edit').value;
        const email = document.getElementById('swal-email-edit').value;
        const matricule = document.getElementById('swal-matricule-edit').value;
        const role = document.getElementById('swal-role-edit').value;
        if (!fullname || !email || !matricule || !role) {
          Swal.showValidationMessage('Veuillez remplir tous les champs.');
          return false;
        }
